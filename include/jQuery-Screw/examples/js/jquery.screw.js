 	...
 	$.fn.extend({ 
 		...
 		screw: function(options) {
    		...
    		return this.each(function() {   		  
			  ...
			  // pinterest style the newly auto loaded weibo list
			  masonryContainer(count);
                ...
                $(".screw").each(function(){
                    ...
                    if(!$(this).hasClass('screw-loaded') || $(this).hasClass('screw-repeat')){
                        ...
                        if(option.loadingHTML){
                            ...
                            // increase the loadCount the load gif is loaded every time
							count++;
              ...
              var showContent = function(rand){
                ...
                if(option.loadingHTML){
				  ...
				  //var containerId = 'container' + loadCount.innerHTML;
				  //alert(containerId );
                  //var wall = new Masonry( document.getElementById('container') );
				  //var loadCount = document.getElementById('loadCount');
			     //loadCount.value = rand;
